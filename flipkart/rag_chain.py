    ...
    def build_chain(self):
        ...
        context_prompt=ChatPromptTemplate.from_messages(
            [
             ...
             MessagesPlaceholder(variable_name="chat_hisotry"),
             ("human","{input}")
            ]
        )
        ...
        qa_prompt=ChatPromptTemplate.from_messages(
            [
                "system","you are a e-commerce bot answer user question from product reviews and product titlle, be concise Context: {context}, input : {input}",
